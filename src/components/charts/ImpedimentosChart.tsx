...
export default function ImpedimentosChart({ data }: Props) {
  if (!data.length) return <div className="flex items-center justify-center h-48 text-slate-400 text-sm">Sin datos</div>;

  return (
    <div>
      <h3 className="font-semibold text-slate-700 text-sm mb-3">Impedimentos para llegar a fin de mes</h3>
      <p className="text-xs text-slate-400 mb-2">Opción múltiple — un encuestado puede marcar varios</p>
